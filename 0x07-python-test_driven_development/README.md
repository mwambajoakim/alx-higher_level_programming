...
## 05 -  Write unittests for the function def max_integer(list=[]):.
```
...
```
- Test file is in the folder `tests`
- Used the `unittest` module
- Test file has the extension `py`
- Test file executed using the command: `python3 -m unittest tests.6-max_integer_test`
