...
## 08 - This class Rectangle inherits from BaseGeometry (7-base_geometry.py). (task based on 8-rectangle.py)
...
## 09 - This class Square inherits from Rectangle (9-rectangle.py):
